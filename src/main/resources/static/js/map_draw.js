...
window.onload = function(){
    console.log("load");
    // 좌표 배열
    var path = [[33.451217710723235, 126.56893778434593],[33.45000154140537, 126.5692234401152],[33.45159894448075, 126.57228087420042]];

    clickLa.push(path.at(0).at(0));
    clickMa.push(path.at(0).at(1));
    clickLa.push(path.at(1).at(0));
    clickMa.push(path.at(1).at(1));
